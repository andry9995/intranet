 ...
 * FactClientAFacturer
 *
 * @ORM\Table(name="fact_client_a_facturer", indexes={@ORM\Index(name="fk_client_a_facturer_client1_idx", columns={"client_id"})})
 * @ORM\Entity
 */
class FactClientAFacturer
{
    /**
     * @var boolean
     *
