 ...
 * Client
 *
 * @ORM\Table(name="client", uniqueConstraints={@ORM\UniqueConstraint(name="nom_UNIQUE", columns={"nom"})}, indexes={@ORM\Index(name="fk_client_forme_juridique1_idx", columns={"forme_juridique_id"})})
...
class Client
{
     ...
     * @var string
     *
     * @ORM\Column(name="login_linxo", type="string", length=45, nullable=true)
     */
    private $loginLinxo;
     ...
     * @var string
     *
     * @ORM\Column(name="mp_linxo", type="string", length=45, nullable=true)
     */
    private $mpLinxo;
     ...
     * @var string
     *
     * @ORM\Column(name="tache_color", type="string", length=10, nullable=true)
     */
    private $tacheColor;
    ...
    /**
     * Set sendNotificationImage
     *
     * @param boolean $sendNotificationImage
     *
     * @return Client
     */
     ...
     * Set loginLinxo
     *
     * @param string $loginLinxo
     *
     * @return Client
     */
    public function setLoginLinxo($loginLinxo)
    {
        $this->loginLinxo = $loginLinxo;
     ...
     * @return string
     */
    public function getLoginLinxo()
    {
        return $this->loginLinxo;
    }

    /**
     * Set mpLinxo
     *
     * @param string $mpLinxo
     *
     * @return Client
     */
    public function setMpLinxo($mpLinxo)
    {
        $this->mpLinxo = $mpLinxo;
     ...
     * Set tacheColor
     *
     * @param string $tacheColor
     *
     * @return Client
     */
    public function setTacheColor($tacheColor)
    {
        $this->tacheColor = $tacheColor;
