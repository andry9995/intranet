 ...
 * Poste
 *
 * @ORM\Table(name="poste", indexes={@ORM\Index(name="fk_poste_cellule1_idx", columns={"cellule_id"}), @ORM\Index(name="fk_poste_operateur1_idx", columns={"operateur_id"}), @ORM\Index(name="ind_codeposte", columns={"code_poste"})})
...
class Poste
{
     ...
     * @var string
     *
     * @ORM\Column(name="code_poste", type="string", length=45, nullable=true)
     */
    private $codePoste;
