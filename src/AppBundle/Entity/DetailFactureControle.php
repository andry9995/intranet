...
/**
 * DetailFactureControle
 *
 * @ORM\Table(name="detail_facture_controle", indexes={@ORM\Index(name="fk_detfactctrl_image_id1_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class DetailFactureControle
{
    /**
     * @var string
     *
