 ...
 * MethodeComptable
 *
 * @ORM\Table(name="methode_comptable", indexes={@ORM\Index(name="fk_methode_comptable_convention_comptable1_idx", columns={"convention_comptable_id"}), @ORM\Index(name="fk_methode_comptable_dossier1_idx", columns={"dossier_id"})})
