 ...
 *
 * @ORM\Table(name="imputation_controle_regle_echeance", indexes={@ORM\Index(name="fk_regleechimpctrl_image_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class ImputationControleRegleEcheance
{
    /**
     * @var integer
     *
     ...
     *
     * @return ImputationControleRegleEcheance
     */
