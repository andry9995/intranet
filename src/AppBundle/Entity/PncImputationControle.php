...
/**
 * PncImputationControle
 *
 * @ORM\Table(name="pnc_imputation_controle", indexes={@ORM\Index(name="fk_pnc_imputation_controle_pnc1_idx", columns={"pnc_id"}), @ORM\Index(name="fk_pnc_imputation_controle_image1_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class PncImputationControle
{
    /**
     * @var integer
     *
