 ...
 * IndicateurLastShow
 *
 * @ORM\Table(name="indicateur_last_show", indexes={@ORM\Index(name="fk_indicateur_last_show_dossier1_idx", columns={"dossier_id"}), @ORM\Index(name="fk_indicateur_last_show_indicateur1_idx", columns={"indicateur_id"}), @ORM\Index(name="fk_indicateur_last_show_type_graphe1_idx", columns={"type_graphe_id"}), @ORM\Index(name="fk_indicateur_last_show_etat_regime_fiscal1_idx", columns={"etat_regime_fiscal_id"})})
 * @ORM\Entity
 */
