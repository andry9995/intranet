 ...
 * Saisie2
 *
 * @ORM\Table(name="saisie2", indexes={@ORM\Index(name="fk_saisie_fournisseur_journal_dossier1_idx", columns={"journal_dossier_id"}), @ORM\Index(name="fk_saisie_fournisseur_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_saisie_fournisseur_type_piece1_idx", columns={"type_piece_id"}), @ORM\Index(name="fk_saisie_fournisseur_type_achat_vente1_idx", columns={"type_achat_vente_id"}), @ORM\Index(name="fk_saisie_fournisseur_devise1_idx", columns={"devise_id"}), @ORM\Index(name="fk_saisie_fournisseur_mode_reglement1_idx", columns={"mode_reglement_id"}), @ORM\Index(name="fk_saisie2_soussouscategorie1_idx", columns={"soussouscategorie_id"}), @ORM\Index(name="fk_pays_id_idx", columns={"pays_id"}), @ORM\Index(name="fk_saisie_sousnatureid10_idx", columns={"sousnature_id"}), @ORM\Index(name="fk_saisie_cerfaid2_idx", columns={"cerfa_id"}), @ORM\Index(name="fk_saisie2_organisme1_idx", columns={"organisme_id"}), @ORM\Index(name="fk_saisie2_banquecompteid_idx", columns={"banque_compte_id"}), @ORM\Index(name="fk_saisie2_manuscr_idx", columns={"mention_manuscrite_id"}), @ORM\Index(name="fk_saisie2_ndfutser_idx", columns={"ndf_utilisateur_id"}), @ORM\Index(name="fk_saisie2_imageflaguer_idx", columns={"image_flague_id"}), @ORM\Index(name="fk_saisie2_carte_bleu_banque_compte1_idx", columns={"carte_bleu_banque_compte_id"})})
 * @ORM\Entity
 */
class Saisie2
{
