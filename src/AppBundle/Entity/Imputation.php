...
class Imputation
{
     ...
     * @var integer
     *
     * @ORM\Column(name="image_flague_id", type="integer", nullable=true)
     */
    private $imageFlagueId;
     ...
     * @var string
     *
     * @ORM\Column(name="nom_tiers", type="string", length=100, nullable=true)
     */
    private $nomTiers;
     ...
     * Set imageFlagueId
     *
     * @param integer $imageFlagueId
     *
     * @return Imputation
     */
    public function setImageFlagueId($imageFlagueId)
    {
        $this->imageFlagueId = $imageFlagueId;
     ...
     * @return integer
     */
    public function getImageFlagueId()
    {
        return $this->imageFlagueId;
    }
