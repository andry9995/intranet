 ...
 * OneClientProspect
 *
 * @ORM\Table(name="one_client_prospect", indexes={@ORM\Index(name="fk_one_client_prospect_one_pays1_idx", columns={"pays_facturation"}), @ORM\Index(name="fk_one_client_prospect_one_pays2_idx", columns={"pays_livraison"}), @ORM\Index(name="fk_one_client_prospect_one_employe1_idx", columns={"one_employe_id"}), @ORM\Index(name="fk_one_client_prospect_one_qualification1_idx", columns={"one_qualification_id"}), @ORM\Index(name="fk_one_client_prospect_one_reglement1_idx", columns={"one_reglement_id"}), @ORM\Index(name="fk_one_client_prospect_one_famille_prix1_idx", columns={"one_famille_prix_id"}), @ORM\Index(name="fk_one_client_prospect_tva_taux1_idx", columns={"taux_tva_id"}), @ORM\Index(name="fk_one_client_prospect_forme_juridique1_idx", columns={"forme_juridique_id"}), @ORM\Index(name="fk_one_client_prospect_dossier1_idx", columns={"dossier_id"})})
 * @ORM\Entity
 */
class OneClientProspect
{
     ...
     * Set paysLivraison
     *
     * @param \AppBundle\Entity\OnePays $paysLivraison
     *
     * @return OneClientProspect
     */
    public function setPaysLivraison(\AppBundle\Entity\OnePays $paysLivraison = null)
    {
     ...
     * Set paysFacturation
     *
     * @param \AppBundle\Entity\OnePays $paysFacturation
     *
     * @return OneClientProspect
     */
    public function setPaysFacturation(\AppBundle\Entity\OnePays $paysFacturation = null)
    {
