 ...
 *
 * @ORM\Table(name="saisie1_regle_echeance", indexes={@ORM\Index(name="fk_regleechsaise1_image_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class Saisie1RegleEcheance
{
    /**
     * @var integer
     *
