 ...
 * TvaSaisie1
 *
 * @ORM\Table(name="tva_saisie1", indexes={@ORM\Index(name="fk_image_id20_idx", columns={"image_id"}), @ORM\Index(name="fk_tva_saisie1_type_vente1_idx", columns={"type_vente_id"}), @ORM\Index(name="fk_tva_saisie1_tva_taux1_idx", columns={"tva_taux_id"}), @ORM\Index(name="fk_tva_saisie1_soussouscategorie1_idx", columns={"soussouscategorie_id"}), @ORM\Index(name="fk_tva_saisie1_sousnatureid1_idx", columns={"sousnature_id"}), @ORM\Index(name="fk_tva_saisie1_natureid_idx", columns={"nature_id"}), @ORM\Index(name="fk_tva_saisie1_pcc1_idx", columns={"pcc_id"}), @ORM\Index(name="fk_tva_saisie1_tiers1_idx", columns={"tiers_id"}), @ORM\Index(name="fk_tva_saisie1_pccbilan_idx", columns={"pcc_bilan_id"}), @ORM\Index(name="fk_tva_saisie1_pcctva_idx", columns={"pcc_tva_id"}), @ORM\Index(name="fk_tva_saisie1_caisse_nature1_idx", columns={"caisse_nature_id"}), @ORM\Index(name="fk_tva_saisie1_caisse_type1_idx", columns={"caisse_type_id"}), @ORM\Index(name="fk_tva_saisie1_code_analytique1_idx", columns={"code_analytique_id"}), @ORM\Index(name="fk_tva_saisie1_mode_reglement1_idx", columns={"mode_reglement_id"}), @ORM\Index(name="fk_tva_saisie1_journal_dossier1_idx", columns={"journal_dossier_id"}), @ORM\Index(name="fk_tva_saisie1_pays1_idx", columns={"pays_id"}), @ORM\Index(name="fk_tva_saisie1_devise1_idx", columns={"devise_id"}), @ORM\Index(name="fk_tva_saisie1_condition_depense1_idx", columns={"condition_depense_id"}), @ORM\Index(name="fk_tva_saisie1_vehicule1_idx", columns={"vehicule_id"})})
 * @ORM\Entity
 */
class TvaSaisie1
{
