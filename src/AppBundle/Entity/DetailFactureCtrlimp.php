...
/**
 * DetailFactureCtrlimp
 *
 * @ORM\Table(name="detail_facture_ctrlimp", indexes={@ORM\Index(name="fk_detfactctrlimp_image_id1_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class DetailFactureCtrlimp
{
    /**
     * @var string
     *
