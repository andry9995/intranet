 ...
 * IndicateurSpecGroup
 *
 * @ORM\Table(name="indicateur_spec_group", uniqueConstraints={@ORM\UniqueConstraint(name="dossier_id_UNIQUE", columns={"dossier_id"})}, indexes={@ORM\Index(name="fk_indicateur_spec_group_indicateur_group1_idx", columns={"indicateur_group_id"}), @ORM\Index(name="fk_indicateur_spec_group_client1_idx", columns={"client_id"}), @ORM\Index(name="fk_indicateur_spec_group_dossier1_idx", columns={"dossier_id"})})
 * @ORM\Entity
 */
