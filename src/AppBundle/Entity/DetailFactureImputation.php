...
/**
 * DetailFactureImputation
 *
 * @ORM\Table(name="detail_facture_imputation", indexes={@ORM\Index(name="fk_detfactimp_image_id1_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class DetailFactureImputation
{
    /**
     * @var string
     *
     ...
     *
     * @return DetailFactureImputation
     */
