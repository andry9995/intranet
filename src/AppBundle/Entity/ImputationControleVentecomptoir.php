...
/**
 * ImputationControleVentecomptoir
 *
 * @ORM\Table(name="imputation_controle_ventecomptoir", indexes={@ORM\Index(name="fk_imputation_ctrvente_comptoir_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_imputation_ctrvente_comptoir_tva_taux1_idx", columns={"tva_taux_id"}), @ORM\Index(name="fk_imputation_ctrvente_comptoir_caisse_nature1_idx", columns={"caisse_nature_id"}), @ORM\Index(name="fk_imputation_ctrventre_controir_caisse_type1_idx", columns={"caisse_type_id"})})
 * @ORM\Entity
 */
class ImputationControleVentecomptoir
{
    /**
     * @var string
     *
     ...
     *
     * @return ImputationControleVentecomptoir
     */
