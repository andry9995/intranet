 ...
 *
 * @ORM\Table(name="imputation_regle_echeance", indexes={@ORM\Index(name="fk_regleechimp_image_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class ImputationRegleEcheance
{
    /**
     * @var integer
     *
     ...
     *
     * @return ImputationRegleEcheance
     */
