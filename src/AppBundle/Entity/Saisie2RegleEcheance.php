 ...
 *
 * @ORM\Table(name="saisie2_regle_echeance", indexes={@ORM\Index(name="fk_regleechsaise2_image_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class Saisie2RegleEcheance
{
    /**
     * @var integer
     *
