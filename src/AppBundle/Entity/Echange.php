 ...
 * Echange
 *
 * @ORM\Table(name="echange", uniqueConstraints={@ORM\UniqueConstraint(name="uk_echange_dossier_exercice", columns={"exercice", "dossier_id", "echange_type_id"})}, indexes={@ORM\Index(name="fk_echange_dossier_idx", columns={"dossier_id"}), @ORM\Index(name="fk_echange_echange_type_idx", columns={"echange_type_id"})})
 * @ORM\Entity
 */
class Echange
{
