 ...
 * FactClientAssocie
 *
 * @ORM\Table(name="fact_client_associe", uniqueConstraints={@ORM\UniqueConstraint(name="client_client_UNIQUE", columns={"client_principal", "client_autre"})}, indexes={@ORM\Index(name="fk_client_associe_client1_idx", columns={"client_principal"}), @ORM\Index(name="fk_client_associe_client2_idx", columns={"client_autre"})})
 * @ORM\Entity
 */
