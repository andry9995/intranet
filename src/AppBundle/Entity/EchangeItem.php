 ...
 * EchangeItem
 *
 * @ORM\Table(name="echange_item", uniqueConstraints={@ORM\UniqueConstraint(name="uk_echange_item_echange_numero", columns={"numero", "echange_id"})}, indexes={@ORM\Index(name="fk_echange_item_echange_idx", columns={"echange_id"}), @ORM\Index(name="fk_echange_item_echange_idtem_id_idx", columns={"echange_item_id"})})
 * @ORM\Entity
 */
class EchangeItem
{
