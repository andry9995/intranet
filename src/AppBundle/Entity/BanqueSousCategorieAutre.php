...
class BanqueSousCategorieAutre
{
     ...
     * @var float
     *
     * @ORM\Column(name="montant_com", type="float", precision=10, scale=0, nullable=true)
     */
    private $montantCom;
     ...
     * @var string
     *
     * @ORM\Column(name="beneficiaire", type="string", length=250, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="commentaire_1", type="string", length=250, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="commentaire_2", type="string", length=250, nullable=true)
     */
     ...
     * @return BanqueSousCategorieAutre
     */
    public function setMontantCom($montantCom)
    {
