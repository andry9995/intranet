 ...
 * Ecriture
 *
 * @ORM\Table(name="ecriture", indexes={@ORM\Index(name="fk_ecriture_pcg_dossier1_idx", columns={"pcc_id"}), @ORM\Index(name="fk_ecriture_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_ecriture_journal_dossier1_idx", columns={"journal_dossier_id"}), @ORM\Index(name="fk_ecriture_tiers1_idx", columns={"tiers_id"}), @ORM\Index(name="fk_ecriture_dossier_idx", columns={"dossier_id"}), @ORM\Index(name="fk_ecriture_historique_upload1_idx", columns={"historique_upload_id"}), @ORM\Index(name="index_ecriture_dossier_exercice", columns={"dossier_id", "exercice"}), @ORM\Index(name="index_ecriture_dossier_pcc_exercice", columns={"dossier_id", "pcc_id", "exercice"})})
