...
class TacheRepository extends EntityRepository {
  ...
  public function getTachesPourGestionTaches($dossiers, $periode,
    ...
    if($client){
      $jourFeries = Functions::getJourFerie($client, $periode);
...
*/
  ...
  public function remplirJourFerie()
  {
    $client =  $this->getEntityManager()->getRepository('AppBundle:Client')->find(559);
    $periode = new \DateTime("now");
    $jourFeries = Functions::getJourFerie($client, $periode);
    return $jourFeries;
  }
}